  ...
  return (
    <div>
      <div className="bg-black flex lg:flex-row flex-col gap-10 font-Montserrat items-center w-fit 69">
        <div className="lg:w-[40%] w-[100%] lg:h-[1800px] md: h-[400px]"
        style={{
            ...
            <div className="flex gap-6 pt-14">
              ...
              <div>
                ...
                <div
                  className="text-[16px] leading-7 font-light"
                >
                <p>Eventually, the market share grew and there was a need to introduce the selling of full boxes of pizza. The first commercial full box of pizza was sold on 14th April 2018. It then continued from that day until June 2018 where business went on a recess due to financial obstacles.</p> 
                
                <p className="pt-5">On 7th September 2018, Pizzaman was moved from the apartment in Kotei to a small shop at Ayeduase, opposite the Victory Towers Hostel. From that period, pizza was sold daily. A revenue of GHC12,000 was generated in the first month of operation, which looked promising. October 2018 would have been a great month until there was a student demonstration at KNUST which led to the closedown of the pizzeria since the market was targeted at students during those moments.</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-6 pt-14">
              ...
              <div>
                ...
                <div
                  className="text-[16px] leading-7 font-light"
                >
                <p>We had a joint venture agreement with Quick Angels GHANA limited.</p> 
                <p className="pt-5">And that was when we came up with Chickenman, a sister brand to pizzaman and they are all under CEQA foods. The idea of chickenman was not to make the pizza over shadow our rice dishes</p>  
                <p className="pt-5">Pizzaman along the line attracted some innovators, and these people eventually became a part of the team. Miss Kekeli Awume and Mr. Martin Dari.In May 2019, Pizzaman closed down again and came up stronger with a sister Brand Called Chickenman in January 2020.</p>
                </div>
              </div> 
            </div>
      ...
      <div className="lg:py-32 py-16 px-10 flex flex-wrap gap-10 items-center">
        <div className="md:w-[35%] w-full">
          <h3 className="text-[#e93e21] text-lg font-semibold">CHEFS FOR PASSION</h3>
        ...
        <a href="" className="px-8 py-2 border border-black hover:bg-black hover:text-white transition-all duration-200 ease-out" >View More</a>
        </div>
      </div>
