            ...
            <div className=' flex justify-center'>
                <div className='flex flex-col justify-center items-center mt-36'>
                    ...
                    <div className='flex mt-12 text-slate-900 justify-center text-[17px] font-medium border-b-2 border-[#e93e21] gap-5 md:px-20 min-w-[40vw]'>
                        <div className='rounded-t-[3px] text-slate-900 px-6 py-3 hover:bg-[#e93e21] hover:text-white cursor-pointer' onClick={displayAccra}>
                            Accra
                        </div>
                        <div className='kumasi rounded-t-[3px] px-6 py-3 hover:bg-[#e93e21] hover:text-white cursor-pointer' onClick={displayKumasi}>
                            Kumasi
                        </div>
                        <div className='rounded-t-[3px] px-6 py-3 hover:bg-[#e93e21] hover:text-white cursor-pointer' onClick={displayTrucks}>
                            Trucks
                        </div>
                    </div>
