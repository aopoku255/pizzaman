...
const Story = () => {
  ...
  return (
    <div className=" about mt-2 md:flex justify-start items-center md:flex-row md:py-32 py-10 gap-x-4 md:px-14 px-4">
       <div className='flex flex-col flex-1'>
          <h4 className='text-white md:text-6xl text-4xl text-center md:text-start font-custom'>Mastering Pizza <br />Perfection.</h4>
            <p className='text-gray-300 font-medium mt-3 pl-2 text-lg '>
      ...
      <div className="video-overlay mt-4">
       ...
       <Modal isOpen={modal} toggle={toggle} className='modal'>
        ...
        <AiOutlineClose color='#fff' onClick={handleClose} size={40}/>
          ...
          <iframe className='youtube md:w-[670px] md:h-[400px] w-full h-full ' 
            // width="670" height="400" 
            src="https://www.youtube.com/embed/NJa8hiyVwWU?si=tNmx9yjvmSt6nVDz" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen  autoplay></iframe>
